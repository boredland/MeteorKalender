...
then
  ...
  RESULT_MESSAGE="Sucessfully deployed <"$DESTINATION_URL"|#"$TRAVIS_BUILD_NUMBER"> for commit <"$TRAVIS_COMMIT"|https://github.com/boredland/MeteorKalender/commit/"$TRAVIS_COMMIT">.";
else
